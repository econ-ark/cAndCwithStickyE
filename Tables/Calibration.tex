...
\footnotesize \textbf{Note:} As discussed in online Appendix~\ref{app:Calibration}, we calibrate to the steady state values from a perfect foresight DGSE model.}
\end{tabular}
\end{table}
