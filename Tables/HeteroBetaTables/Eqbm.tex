...
\label{Table:HeteroEqbm}  
\newsavebox{\HeteroEqbmBox}  
\sbox{\HeteroEqbmBox}{  
...
\\ \bottomrule  
 ...
 \usebox{\HeteroEqbmBox}  
\ifthenelse{\boolean{StandAlone}}{\newlength\TableWidth}{}  
\settowidth\TableWidth{\usebox{\HeteroEqbmBox}} % Calculate width of table so notes will match  
