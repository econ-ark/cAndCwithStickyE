\begin{table} \caption{Aggregate Consumption Dynamics in SOE Model (Parker Experiment)} \label{tPESOEsimHetero} 
...
\\ (0.060) & & & & & 
\\ 0.800^{\bullet \bullet \bullet } & & & IV & 0.255 & 0.000
\\ (0.111) & & & & &0.518
\\ & 0.778^{\bullet \bullet \bullet } & & IV & 0.218 & 0.041
\\ & (0.138) & & & &0.224
\\ & & -1.15\text{e--4} & IV & 0.040 & 0.000
\\ & & (1.41\text{e--4}) & & &0.004
\\ 0.612^{\bullet \bullet \bullet } & 0.247 & 0.53\text{e--4} & IV & 0.262 & 0.282
\\ (0.183) & (0.210) & (1.47\text{e--4}) & & & 0.515
\\ \multicolumn{6}{l}{Memo: For instruments $\mathbf{Z}_{t}$, $\Delta \log \mathbf{C}_{t}^*$ $= \mathbf{Z}_{t} \zeta, ~\bar{R}^{2}=$ 0.261; ~$\var(\log(\xi_t))=$ 4.85\text{e--6} }  
\\ \bottomrule 
 \multicolumn{6}{c}{
