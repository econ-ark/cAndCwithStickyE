...
\begin{adjustwidth}{-1em}{-1em}
  ...
  \ifthenelse{\boolean{ifWeb}}{}{\begin{small}} %\end{Web}
    \parbox{\textwidth}{
      \begin{center}
        \begin{tabbing}
          \texttt{~~~~~PDF:~} \= \= \url{http://llorracc.github.io/cAndCwithStickyE/cAndCwithStickyE.pdf} \\ %\kill \\  % This line establishes the locations of the tabs, but is not printed because of the \kill directive
