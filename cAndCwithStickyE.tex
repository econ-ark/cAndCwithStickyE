...
\href{https://econ-ark.org}{\includegraphics{./Figures/PoweredByEconARK}}}
  ...
  \ifthenelse{\boolean{ifWeb}}{}{\begin{small}} %\end{Web}
    \parbox{\textwidth}{
      \begin{center}
        \begin{tabbing}
          \texttt{~~~~~PDF:~} \= \= \url{https://llorracc.github.io/cAndCwithStickyE/cAndCwithStickyE.pdf} \\ %\kill \\  % This line establishes the locations of the tabs, but is not printed because of the \kill directive
...
\footnotesize \thankstext \medskip \medskip \medskip  }}{\pagebreak } % \end{Web}
\setcounter{page}{1}
...
\appendix\input{./cAndCwithStickyE-App.texinput}\appendix\input{./cAndCwithStickyE-App.texinput}\end{document}
